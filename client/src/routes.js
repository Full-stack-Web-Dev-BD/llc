...
// My  Pages 
const UserManagement = React.lazy(() => import('./views/pages/OrganizationManagement/UserManagement/UserManagement'));
const Branches = React.lazy(() => import('./views/pages/OrganizationManagement/Branches/Branches'));
